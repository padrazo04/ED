...
*/
	...
	std::cout << BIGREEN;
	std::cout<< "Operadores aritméticos y asignación "<< std::endl;
	std::cout << RESET;

		// Entre dos polinomios
	std::cout << BIGREEN;
	std::cout<< "Operadores aritméticos y asignación: dos polinomios "<< std::endl;
	std::cout << RESET;
	...
	std::cout << BIGREEN;
	std::cout<< "Operadores aritméticos y asignación: polinomio y monomio "<< std::endl;
	std::cout << RESET;
	...
	// Entre un polinomio y un número
	std::cout << BIGREEN;
	std::cout<< "Operadores aritméticos y asignación: polinomio y número "<< std::endl;
	std::cout << RESET;
